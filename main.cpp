...
int main()
{
    ...
    else if (line[0] == '1')
    {
        ...
        g.addShip(2, 'P', "test");
        Player* p1 = createPlayer("good", "Mediocre Popeye", g);
        Player* p2 = createPlayer("good", "Good Bluto", g);
...
int main()
{
    ...
    else if (line[0] == '1')
    {
        ...
        Player* p2 = createPlayer("good", "Bluto", g);
        cout << "This mini-game has one ship, a 2-segment rowboat." << endl;
        g.play(p1, p2);
        delete p1;          // update destructors
        delete p2;
    }
    else if (line[0] == '2')
    {
        Game g(10, 10);
        addStandardShips(g);
        Player* p1 = createPlayer("good", "Good Midori", g);
        Player* p2 = createPlayer("human", "Shuman the Human", g);
        g.play(p1, p2);
        delete p1;
        delete p2;
